...
const textNodeDictionary = {
  ko: {
    ...
    "I contributed to the collaborative team project through specific survey, field research, and interpretation work.": "협업 기반 팀 프로젝트 안에서 설문, 현장 조사, 해석 작업에 구체적으로 기여했습니다.",
    "Survey": "설문",
    "Primary Responsibility": "주요 담당",
    "01 Survey Methodology\n02 Survey Analysis & Findings": "01 설문 방법론\n02 설문 분석 및 결과 도출",
    "Field Research": "현장 연구",
    "Active Participation": "적극 참여",
    "Food Waste Audit\nCanada Room Field Research\nField Observation & Data Collection": "음식물 쓰레기 감사\nCanada Room 현장 조사\n현장 관찰 및 데이터 수집",
    "Analysis": "분석",
    "Research Interpretation": "연구 결과 해석",
    "Contributed to interpreting findings and shaping the final research output.": "연구 결과를 해석하고 최종 연구 산출물을 구성하는 과정에 기여했습니다.",
