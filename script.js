...
const textNodeDictionary = {
  ko: {
    ...
    "온라인 참여": "온라인 참여",
    "Environmental Information · Stories · Community": "환경 정보 · 이야기 · 커뮤니티",
    "Participation": "Participation",
    "참여 기회": "참여 기회",
    "Petitions · Challenges · Calls to Action": "청원 · 챌린지 · 행동 요청",
    "Real-World Action": "Real-World Action",
    "실제 행동": "실제 행동",
    ...
    "Activity-Peak Sampling": "Activity-Peak Sampling",
    ...
    "Survey + Food Waste Audit & Field Observation + Staff Interviews → Mixed-Methods Research": "설문 + Food Waste Audit & 현장 관찰 + 직원 인터뷰 → Mixed-Methods Research",
    "Approach · Mixed-Methods Research": "접근 방식 · Mixed-Methods Research",
