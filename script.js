...
const dictionary = {
  ko: {
    ...
    env421KeyInsight: "서로 다른 연구 방법은 인간 행동의 서로 다른 부분을 보여줍니다.",
  ...
  en: {
    ...
    env421KeyInsight: "Different methods reveal different parts of human behavior.",
...
const textNodeDictionary = {
  ko: {
    ...
    "What defines the boundary between human and artificial?": "인간과 인공적인 것의 경계는 무엇으로 정의되는가?",
    "Limitation": "한계",
    "Paradox": "역설",
    "Human Writing": "인간 글쓰기",
    "AI Generation": "AI 생성",
    "Comparison": "비교",
    "Recognition": "인정",
    "Identity": "정체성",
    "Boundary": "경계",
    "The works made the human/artificial boundary more visible.": "세 작품은 인간과 인공적인 것의 경계를 더 분명하게 보여주었습니다.",
    "AI-Generated Writing": "AI 생성 글쓰기",
    "Comparison → Evaluation → Revision": "비교 → 평가 → 수정",
    "Human Judgment": "인간 판단",
    "Deciding what to keep, revise, or reject.": "무엇을 유지하고, 수정하고, 제외할지 판단하기.",
    "Action Pathway": "행동 경로",
    "Structured Information": "구조화된 정보",
    "Trust Mechanism": "신뢰 구조",
    "Design Response": "디자인 응답",
    "Meaningful Participation": "의미 있는 참여",
    "Information becomes a pathway to action rather than the end of engagement.": "정보가 참여의 끝이 아니라 행동으로 이어지는 경로가 됩니다.",
    "Trusted Information + Action Pathway": "신뢰 가능한 정보 + 행동 경로",
    "Source": "출처",
    "Requirement": "요구",
    "Flag": "신고",
    "Screen": "선별",
    "Review": "검토",
    "Raw PM2.5 Data": "원자료 PM2.5 데이터",
    "Map": "지도",
    "Where?": "어디에서?",
    "Distribution": "분포",
    "How different?": "얼마나 다른가?",
    "What changed?": "무엇이 달라졌는가?",
    "Pattern Interpretation": "패턴 해석",
    "Combined Comparison": "통합 비교",
    "Cross-Session Findings": "세션 간 발견",
    "Mixed-Methods Synthesis": "혼합방법 종합",
    "Behavioral Understanding": "행동 이해",
    "Connecting self-reported, observed, and operational evidence.": "자기보고, 관찰, 운영 관점의 근거를 연결했습니다.",
    "Survey Evidence": "설문 근거",
    "Reported discarded foods and preferred interventions.": "버려지는 음식과 선호 개입 방식에 대한 응답.",
    "Observed Evidence": "관찰 근거",
    "Audit findings from dining hall contexts.": "다이닝홀 맥락에서의 감사 결과.",
    "Contextual Evidence": "맥락 근거",
    "Interpretation → Recommendation": "해석 → 제안",
    "Preventive + Institutional Responses": "예방적 + 제도적 대응",
    "Flexible Portions · Taste Tests · Awareness · Regular Audits · Dining Hall Collaboration": "유연한 양 선택 · 시식 · 인식 개선 · 정기 감사 · 다이닝홀 협업",
    "Contents": "목차",
    "Project Overview": "프로젝트 개요",
    "Research Question": "연구 질문",
    "Research / Design Question": "연구 / 디자인 질문",
    "Design Outcome": "디자인 결과",
    "Findings / Reflection": "분석 결과 / 회고",
    ...
    "Questioning humanity through AI.": "AI를 통해 인간성을 다시 묻다",
    "By analyzing artificial beings in literature alongside generative AI writing, I explored how humans define the boundaries of identity, emotion, relationships, and judgment.": "문학 속 인공 존재와 생성형 AI 글쓰기를 함께 분석하며, 인간이 정체성, 감정, 관계와 판단의 경계를 어떻게 정의하는지 탐구했습니다.",
    "Through critical analysis of artificial beings in literature and Human × AI writing comparison, I explored how humans define the boundaries of identity, emotion, relationships, and judgment.": "문학 속 인공 존재에 대한 비판적 분석과 Human × AI 글쓰기 비교를 통해, 인간이 정체성, 감정, 관계와 판단의 경계를 어떻게 정의하는지 탐구했습니다.",
    "What can artificial beings reveal about how we define “humanity”?": "인공 존재는 우리가 ‘인간다움’을 정의하는 방식에 대해 무엇을 드러내는가?",
    "Approach": "접근 방식",
    "Cross-Text Analysis · Critical Interpretation · Human × AI Writing Comparison": "작품 간 비교 분석 · 비판적 해석 · Human × AI 글쓰기 비교",
    ...
    "Human-like emotion alone did not guarantee recognition as human.": "인간과 유사한 감정을 가진다는 것만으로 인간으로 인정받는 것은 아니었습니다.",
    "As human behavior was reproduced, the question of whether identity itself could be reproduced became more visible.": "인간 행동을 재현할수록 정체성 자체가 재현될 수 있는가라는 질문이 드러났습니다.",
    ...
    "Empathy & Relationships": "공감과 관계",
    "Emotional connection and relationships appeared as important boundaries between human and artificial beings.": "정서적 연결과 관계는 인간과 인공 존재를 구분하는 중요한 경계로 나타났습니다.",
    "Cross-Text Synthesis": "작품 간 종합",
    "The three works showed how humans construct the boundary of “humanity” through artificial beings.": "세 작품은 인공 존재를 통해 오히려 인간이 ‘인간다움’의 경계를 어떻게 구성하는지를 보여주었습니다.",
    "Critical Interpretation · Textual Depth · Contextual Judgment": "비판적 해석 · 텍스트의 깊이 · 맥락적 판단",
    "Human Writing": "인간 글쓰기",
    "AI-Generated Writing": "AI 생성 글쓰기",
    ...
    "Concision": "간결성",
    "Structure": "구조",
    "Comparison & Revision": "비교와 수정",
    "Human × AI Writing Comparison": "Human × AI 글쓰기 비교",
    "Comparison & Reflection": "비교와 회고",
    "In comparing and revising the two versions, I did not accept the AI output as-is; I judged what to keep, revise, or exclude based on context and argument.": "두 글을 비교하고 수정하는 과정에서 AI의 결과물을 그대로 수용하기보다, 맥락과 논증에 따라 무엇을 유지하고 수정하거나 제외할지 판단했습니다.",
    "What should be kept, revised, or rejected?": "무엇을 유지하고 수정하거나 거부할 것인가?",
    "What interested me was not simply how well AI imitates humans, but how humans interpret and judge what AI produces.": "제가 관심을 갖게 된 것은 AI가 인간을 얼마나 잘 모방하는지가 아니라, 인간이 AI의 결과물을 어떻게 해석하고 판단하는가였습니다.",
    ...
    "PANDO: from online information to offline action.": "PANDO\n온라인 정보에서 오프라인 행동으로",
    "By analyzing passive engagement, information overload, and trust problems in existing social media, I proposed an alternative platform that connects environmental information to community participation.": "기존 소셜미디어의 수동적 참여, 정보 과잉과 신뢰 문제를 분석하고, 환경 정보를 실제 커뮤니티 참여로 연결하는 대안적 플랫폼을 제안했습니다.",
    "By analyzing passive engagement, information overload, and trust problems in existing social media, I proposed PANDO as an alternative platform connecting environmental information to community participation.": "기존 소셜미디어의 수동적 참여, 정보 과잉과 신뢰 문제를 분석하고, 환경 정보를 실제 커뮤니티 참여로 연결하는 대안적 플랫폼 PANDO를 제안했습니다.",
    ...
    "Online reactions may remain as one-time participation inside the platform.": "온라인 반응이 플랫폼 내부의 일회성 참여에 머물 수 있습니다.",
    "Too much information can make real participation opportunities difficult to find.": "많은 정보 속에서 사용자가 실제 참여 기회를 찾기 어렵습니다.",
    "Trust Problem": "신뢰 문제",
    "Information that is difficult to trust can weaken the pathway from information to action.": "신뢰하기 어려운 정보는 행동으로 이어지는 과정을 약화시킬 수 있습니다.",
    ...
    "How can environmental information lead to actual participation and action?": "환경 정보는 어떻게 실제 참여와 행동으로 이어질 수 있을까?",
    "Problem Analysis · Literature Review · Concept Design": "문제 분석 · 문헌 검토 · 콘셉트 설계",
    ...
    "Offline Action": "오프라인 행동",
    "Real-World Action": "실제 행동",
    "Events · Volunteering · Community Initiatives": "행사 · 봉사 · 커뮤니티 이니셔티브",
    "Source Requirement · Community Flagging · Automated Screening · Human Review": "출처 요구 · 커뮤니티 신고 · 자동 선별 · 인간 검토",
    "Synthesis": "종합",
    "Recommendations": "제안",
    "Participation Pathway": "참여 경로",
    "Trust & Information Quality": "신뢰와 정보 품질",
    "Design Response": "디자인 대응",
    "Features": "기능",
    "Action Opportunities": "행동 기회",
    "Structured Information": "구조화된 정보",
    "Trust Structure": "신뢰 구조",
    "Petitions": "청원",
    "Challenges": "챌린지",
    "Events": "행사",
    "Volunteering": "봉사",
    ...
    "Community": "커뮤니티",
    "Opportunities": "참여 기회",
    "Source Citation": "출처 표기",
    "Reporting": "신고",
    "Filtering": "선별",
    "Information → Engagement → Action": "정보 → 참여 → 행동",
    "Inform": "정보 제공",
    "Connect": "연결",
    "Participate": "참여",
    "Act Offline": "오프라인 행동",
    "Stories · Community": "이야기 · 커뮤니티",
    ...
    "Source Transparency": "출처 투명성",
    "Community Reporting": "커뮤니티 신고",
    "Automated Filtering": "자동 선별",
    "Design Principle": "디자인 원칙",
    "I designed a credible information structure alongside a clear participation pathway to connect information consumption with potential real-world participation.": "신뢰할 수 있는 정보 구조와 명확한 참여 경로를 함께 설계해, 정보 소비를 실제 참여로 연결하고자 했습니다.",
    ...
    "Turning environmental data into visual insight.": "환경 데이터를 시각적 인사이트로 전환하기",
    "I collected PM2.5 data across three sampling sessions under different activity and weather conditions, then used maps and distribution visualizations to compare spatial and condition-based patterns.": "서로 다른 활동과 날씨 조건에서 세 차례 PM2.5 데이터를 직접 수집하고, 지도와 분포 시각화를 통해 공간적·조건별 패턴을 비교했습니다.",
    "How can visualization reveal patterns in environmental data that are difficult to see from raw measurements alone?": "시각화는 원자료만으로 보기 어려운 환경 데이터의 패턴을 어떻게 드러낼 수 있는가?",
    "Data": "데이터",
    "Visualize": "시각화",
    "Compare": "비교",
    "Interpret": "해석",
    "Field Data Collection → Visualization → Comparison → Interpretation": "현장 데이터 수집 → 시각화 → 비교 → 해석",
    ...
    "Exploratory Sampling": "탐색적 샘플링",
    "Peak Activity": "활동 피크",
    "Comparative Condition": "비교 조건",
    "Activity-Peak Sampling": "활동 피크",
    ...
    "Focused sampling around the food-truck corridor during a high-activity lunch period.": "점심시간 푸드트럭 구역을 중심으로 활동이 많은 조건을 측정했습니다.",
    "Same corridor measured again under rainy/lower-activity conditions.": "비가 오고 활동량이 낮은 조건에서 같은 구역을 다시 측정했습니다.",
    "The same area was measured again on a rainy, lower-activity day.": "비가 오고 활동량이 낮은 날 같은 구역을 다시 측정했습니다.",
    ...
    "A broad range of PM2.5 variation was observed across locations.": "위치에 따라 PM2.5 값의 넓은 변동 범위가 관찰되었습니다.",
    "Greater short-term variability was observed under higher-activity conditions.": "활동이 많은 조건에서 더 큰 단기 변동성이 관찰되었습니다.",
    "The rainy, lower-activity condition showed a relatively lower and more stable distribution.": "비가 오고 활동량이 낮은 조건에서는 상대적으로 낮고 안정적인 분포가 관찰되었습니다.",
    "Broad Spatial Variation": "넓은 공간적 변동",
    "Broad Distribution Range": "넓은 분포 범위",
    "Distinct Concentration Spikes": "뚜렷한 농도 스파이크",
    "Lower Concentration Range": "낮은 농도 범위",
    ...
    "Understanding food waste behavior through multiple forms of evidence.": "여러 형태의 근거로 음식물 쓰레기 행동 이해하기",
    "In collaboration with MealCare, this year-long project combined survey research, food-waste observation, field observation, and staff interviews to investigate food waste in university dining environments.": "1년간 MealCare와 협력하여 설문, 음식물 쓰레기 관찰 조사, 현장 관찰과 직원 인터뷰를 결합해 대학 다이닝 환경의 음식물 쓰레기를 조사했습니다.",
    "In collaboration with MealCare, this year-long project combined survey research, Food Waste Audit, field observation, and staff interviews to investigate food waste in university dining environments.": "MealCare와 협력하여 1년간 설문, Food Waste Audit, 현장 관찰과 직원 인터뷰를 결합해 대학 다이닝 환경의 음식물 쓰레기를 조사했습니다.",
    ...
    "What behavioral and institutional factors contribute to food waste in university dining environments?": "어떤 행동적·제도적 요인이 대학 다이닝 환경의 음식물 쓰레기에 영향을 미치는가?",
    ...
    "Survey": "설문",
    "Methodology Design · Data Analysis · Findings": "방법론 설계 · 데이터 분석 · 결과 도출",
    "Field Research": "현장 연구",
    "Food Waste Audit · Canada Room Research · Observation & Data Collection": "Food Waste Audit · Canada Room 조사 · 관찰 및 데이터 수집",
    "Analysis": "분석",
    "Research Interpretation · Final Research Output": "연구 결과 해석 · 최종 연구 산출물 구성",
    "Research Interpretation · Findings Organization · Research Output Contribution": "연구 결과 해석 · 결과 정리 및 연구 산출물 작성 참여",
    "Survey + Food Waste Audit & Field Observation + Staff Interviews → Mixed-Methods Research": "설문 + Food Waste Audit & 현장 관찰 + 직원 인터뷰 → 혼합방법 연구",
    "Survey · Food Waste Audit · Field Observation · Staff Interviews": "설문 · Food Waste Audit · 현장 관찰 · 직원 인터뷰",
    "What Did Multiple Forms of Evidence Reveal?": "여러 형태의 근거는 무엇을 보여주었는가?",
    "Survey Evidence": "설문 근거",
    "Observed Evidence": "관찰 근거",
    "Contextual Evidence": "맥락 근거",
    "Most frequently reported discarded food type.": "가장 자주 보고된 폐기 음식 유형",
    "Most preferred waste-reduction intervention.": "가장 선호된 감소 방안",
    "Plates with Edible Leftovers": "먹을 수 있는 잔반이 있는 접시",
