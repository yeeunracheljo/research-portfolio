...
const dictionary = {
  ko: {
    ...
    env361OriginalProjectCta: "디자인 보고서 보기",
    ...
    env338CrossLabel: "핵심 발견",
    env338CrossTitle: "시각적 비교",
    ...
    env421OriginalCta1: "최종 연구 보고서 보기",
...
const textNodeDictionary = {
  ko: {
    ...
    "Research / Design Question": "연구 질문",
    "Design Outcome": "디자인 결과",
    "Findings / Reflection": "분석 결과 / 회고",
    "Findings Through Visualization": "핵심 발견",
    "Mixed-Methods Findings": "핵심 발견",
    ...
    "What Did Artificial Beings Reveal?": "인공 존재는 무엇을 드러냈는가?",
    ...
    "Critical Interpretation · Textual Depth": "비판적 해석 · 텍스트의 깊이",
    "Clarity · Concision · Structure": "명료성 · 간결성 · 구조",
    "Comparison": "비교",
    "Keep · Revise · Exclude": "유지 · 수정 · 제외",
    "Revision": "수정",
    "Critical Depth + Clearer Structure": "비판적 깊이 + 더 명확한 구조",
    "Human Judgment": "인간의 판단",
    "Contextual Evaluation": "맥락적 평가",
    "Comparison & Revision": "비교와 수정",
    "Human × AI Writing Comparison": "Human × AI 글쓰기 비교",
    "Comparison & Reflection": "비교와 회고",
    "Comparison & Evaluation": "비교와 평가",
    "Instead of accepting AI-generated writing as-is, I evaluated both versions based on context, interpretation, and argumentative quality, deciding what to keep, revise, or reject.": "AI 생성 글을 그대로 수용하지 않고, 두 버전을 맥락, 해석, 논증의 질을 기준으로 평가하며 무엇을 유지하고 수정하거나 제외할지 판단했습니다.",
    "Rather than accepting AI-generated writing as-is, I compared both versions and evaluated what to keep, revise, or reject based on interpretation, context, and argumentative quality.": "AI 생성 글을 그대로 수용하기보다, 두 버전을 비교하며 해석, 맥락, 논증의 질을 기준으로 무엇을 유지하고 수정하거나 제외할지 평가했습니다.",
    "Key Finding": "핵심 발견",
    "Human judgment remained essential not because AI could not generate convincing writing, but because meaning, context, and interpretation still required human evaluation.": "AI가 설득력 있는 글을 생성하지 못해서가 아니라, 의미와 맥락, 해석에는 여전히 인간의 평가가 필요했기 때문에 인간의 판단이 중요했습니다.",
    ...
    "Engage": "참여 유도",
    "Take Action": "행동",
    "Verified Environmental Feed": "검증된 환경 정보 피드",
    "News Feed · Climate Updates": "News Feed · 기후 정보",
    "Community Stories": "커뮤니티 이야기",
    "Hope Hub · Local Groups": "Hope Hub · 지역 그룹",
    "Petitions & Challenges": "청원과 챌린지",
    "Calls to Action · Volunteer Opportunities": "참여 요청 · 봉사 기회",
    "Offline Participation": "오프라인 참여",
    "Events · Community Initiatives": "행사 · 커뮤니티 활동",
    "Trust Layer": "신뢰 레이어",
    "Source Citation · Community Reporting · Automated Screening · Human Review": "출처 표기 · 커뮤니티 신고 · 자동 선별 · 인간 검토",
    "Online Information": "온라인 정보",
    "Verified environmental news and local updates.": "검증된 환경 뉴스와 지역 업데이트를 제공합니다.",
    "Community Engagement": "커뮤니티 참여",
    "Stories, discussions, and local groups.": "이야기, 토론, 지역 그룹을 연결합니다.",
    "Participation Opportunities": "참여 기회",
    "Petitions, volunteering, events, and challenges.": "청원, 봉사, 행사, 챌린지를 제시합니다.",
    "Real-World Action": "현실 행동",
    "Offline participation in community initiatives.": "커뮤니티 활동으로 오프라인 참여를 확장합니다.",
    ...
    "News Feed for facts · Hope Hub for stories": "사실 정보는 News Feed · 커뮤니티 이야기는 Hope Hub",
    "Separated factual environmental information from community stories to reduce information overload and improve clarity.": "정보 과잉을 줄이고 명확성을 높이기 위해 사실 기반 환경 정보와 커뮤니티 이야기를 분리했습니다.",
    "Separated factual environmental information from community storytelling to reduce information overload while preserving user motivation and engagement.": "정보 과잉을 줄이면서 사용자 동기와 참여를 유지하기 위해 사실 기반 환경 정보와 커뮤니티 스토리텔링을 분리했습니다.",
    "Separated factual environmental information from community storytelling to reduce information overload while maintaining user motivation.": "정보 과잉을 줄이면서 사용자 동기를 유지하기 위해 사실 기반 환경 정보와 커뮤니티 스토리텔링을 분리했습니다.",
    "Participation Design": "참여 설계",
    "Petitions · Challenges · Volunteering · Events": "청원 · 챌린지 · 봉사 · 행사",
    "Integrated volunteering, events, petitions, and challenges as direct pathways from information to action.": "봉사, 행사, 청원, 챌린지를 정보에서 행동으로 이어지는 직접적인 경로로 통합했습니다.",
    "Integrated volunteering, events, petitions, and challenges as clear pathways that connect online information with meaningful offline participation.": "봉사, 행사, 청원, 챌린지를 온라인 정보와 의미 있는 오프라인 참여를 연결하는 명확한 경로로 통합했습니다.",
    "Integrated petitions, volunteering, events, and challenges as visible pathways that connect online information with meaningful offline participation.": "청원, 봉사, 행사, 챌린지를 온라인 정보와 의미 있는 오프라인 참여를 연결하는 가시적인 경로로 통합했습니다.",
    "Trust Mechanisms": "신뢰 장치",
    "Citations · Reporting · Screening · Moderation": "출처 표기 · 신고 · 선별 · 검토",
    "Combined source citation, community reporting, automated screening, and human moderation to improve credibility.": "출처 표기, 커뮤니티 신고, 자동 선별, 인간 검토를 결합해 정보의 신뢰성을 높이고자 했습니다.",
    "Combined source citation, community reporting, automated screening, and human moderation to improve information credibility while supporting informed decision-making.": "출처 표기, 커뮤니티 신고, 자동 선별, 인간 검토를 결합해 정보 신뢰성을 높이고 더 informed한 의사결정을 지원하고자 했습니다.",
    ...
    "Credible information and visible participation options should be designed together.": "신뢰할 수 있는 정보와 명확한 참여 선택지는 함께 설계되어야 합니다.",
    "Credible information and visible participation pathways should be designed together to support real-world environmental action.": "신뢰할 수 있는 정보와 명확한 참여 경로는 실제 환경 행동을 지원하도록 함께 설계되어야 합니다.",
    "Stories · Communities": "이야기 · 커뮤니티",
    "Events · Volunteering · Community Initiatives": "행사 · 봉사 · 커뮤니티 이니셔티브",
    "Environmental engagement depends on what users can verify and do next.": "환경 참여는 사용자가 무엇을 확인하고 다음으로 무엇을 할 수 있는지에 달려 있습니다.",
    ...
    "PANDO reframed the interface as a bridge between online attention and offline environmental action.": "PANDO는 인터페이스를 온라인 관심과 오프라인 환경 행동을 연결하는 매개로 바라보게 했습니다.",
    ...
    "*PM2.5: Fine particulate matter; an air-quality indicator that measures the concentration of fine particles in the air.": "*PM2.5: 공기 중 초미세먼지(Fine Particulate Matter)의 농도를 나타내는 대기질 지표입니다.",
    ...
    "Under conditions where activity and emission sources were concentrated, PM2.5 increased sharply, while rainy and lower-activity conditions remained at lower levels. These findings suggest that environmental conditions and localized human activity interact to shape short-term air quality across campus.": "활동과 배출원이 집중된 조건에서는 PM2.5가 크게 증가한 반면, 비와 낮은 활동량에서는 낮은 수준을 유지했습니다. 이러한 결과는 환경 조건과 국지적인 인간 활동이 상호작용하며 캠퍼스의 단기 대기질을 형성할 수 있음을 시사합니다.",
    ...
    "Survey": "설문",
    "Methodology Design": "방법론 설계",
    "Data Analysis": "데이터 분석",
    "Findings": "결과 도출",
    "Designed survey methodology": "설문 방법론을 설계했습니다",
    "Analyzed survey data": "설문 데이터를 분석했습니다",
    "Interpreted findings": "결과를 해석했습니다",
    "Canada Room": "Canada Room",
    "Observation": "관찰",
    "Data Collection": "데이터 수집",
    "Conducted food waste audits": "음식물 쓰레기 감사를 수행했습니다",
    "Collected observational data": "관찰 데이터를 수집했습니다",
    "Documented dining hall conditions": "다이닝홀 환경을 기록했습니다",
    "Research Interpretation": "연구 결과 해석",
    "Research Output": "연구 산출물",
    "Final Report Contribution": "최종 보고서 기여",
    "Synthesized qualitative and quantitative findings": "정성적·정량적 결과를 종합했습니다",
    "Contributed to the final research report": "최종 연구 보고서 작성에 기여했습니다",
    ...
    "Poor Taste · Undercooking · Appetite · Attention": "맛 부족 · 덜 익은 음식 · 식욕 변화 · 주의 부족",
    ...
    "View Final Project": "최종 프로젝트 보기",
    "View Design Report": "디자인 보고서 보기",
    "View Research Report": "연구 보고서 보기",
    "View Final Research Report": "최종 연구 보고서 보기",
