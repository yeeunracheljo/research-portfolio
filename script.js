...
const textNodeDictionary = {
  ko: {
    ...
    "Designed a participation flow that connects environmental information to real-world action.": "환경 정보를 실제 행동으로 연결하는 참여 흐름을 설계했습니다.",
    "Designed an interaction structure that connects information, people, and community.": "정보와 사람, 커뮤니티를 연결하는 상호작용 구조를 설계했습니다.",
    "Designed a trust structure that includes source checking and review processes.": "출처 확인과 검토 과정을 포함한 신뢰 구조를 설계했습니다.",
    "Separated News Feed for factual updates from Hope Hub for community stories.": "사실 기반 환경 정보는 News Feed로, 커뮤니티 이야기는 Hope Hub로 분리했습니다.",
    "Integrated petitions, volunteering, events, and challenges as participation options.": "청원, 봉사, 행사, 챌린지를 플랫폼 안의 참여 선택지로 통합했습니다.",
    "Added citations, reporting, automated screening, and human moderation.": "출처 표기, 신고, 자동 선별, 인간 검토를 신뢰 장치로 포함했습니다.",
